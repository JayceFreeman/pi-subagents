...
const RETRYABLE_MODEL_FAILURE_PATTERNS = [
	...
	/socket hang up/i,
	/web[\s_-]?socket/i,
	/\bws\s+(?:closed|disconnected|error)\b/i,
	/\bclosed(?:\s+with\s+code)?\s+(?:1000|1001|1006)\b/i,
	/\b(?:ECONNRESET|ECONNREFUSED|ETIMEDOUT|EAI_AGAIN|EPIPE)\b/i,
	/premature close/i,
	/\b(?:underlying\s+)?socket\s+disconnected\b/i,
	/\b(?:connection|socket|stream)\s+(?:was\s+)?closed\s+(?:unexpectedly|by peer)\b/i,
	/\b(?:RST_STREAM|GOAWAY)\b/i,
	/\bstream closed\b/i,
	/upstream/i,
	/timed? out/i,
	/timeout/i,
